# The filter() Function Returns an Iterator where the items are filtered through a function to Test ig the item is accepted or not
...
# Ex 2 Filter() Function with Lamabada Excrepisson
