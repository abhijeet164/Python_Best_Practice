...
# Ex 3 There are two types of method 1)Instance Method 2) Static Method
# 1)Instance Method = can be called by object reference
# 2) Static Method = can be called by class name This is achieved by using annotation @staticmethod Qulifer and This Staticmethod is Common for Every object
...
# 3)Local Variable =Declared Inside the method or function is called local variable scope is limitied to method/functio
...
class myClass:
    ...
    def add(self,a,b):
        print(a+b)
        print(self.a+self.b) # to Access the Class variable use Self KeyWord inside a method
        print(globals()["a"]+globals()["b"]) # Access the Global variable inside a method Directly  by globals()[Variable name]
